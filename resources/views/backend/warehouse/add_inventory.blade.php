...
@section('admin')
@section('title')
    Add Inventory | Pencil POS System
@endsection
{{-- jquery link  --}}
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">စတို ကုန်ပစ္စည်းအသစ် ထည့်ရန်</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="tab-pane" id="settings">
                            <form id="myForm" method="post" action="{{ route('stroe.inventory') }}" enctype="multipart/form-data">
                                @csrf

                                <h5 class="mb-4 text-uppercase"><i class="mdi mdi-account-circle me-1"></i> Add Inventory
                                </h5>
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group mb-3">
                                            ...
                                            <textarea class="form-control" name="description" id="example-textarea" rows="3"></textarea>
                                        </div>
                                    </div>
                                    <!-- end col -->
