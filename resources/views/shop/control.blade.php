        ...
        <div class="col-lg-4 fixed-col">
            <div class="card">
                <div class="card text-center">
                    ...
                    <form action="{{ url('create/control') }}" id="myForm" method="post">
                        @csrf
                        ...
                        <div class="form-group m-2">
                            ...
                            <div class="mb-3">
                                <label for="lastname" class="form-label">Descrption</label>
                                <input type="text" name="description" class="form-control" id="">
                            </div>
                        </div>

                        <button class="btn btn-dark waves-effect waves-light mb-3">Comfirm</button>
                    </form>
                </div>
            </div>
        </div>
